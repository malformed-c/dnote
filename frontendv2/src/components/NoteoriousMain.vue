...
<template>
  ...
  dark:bg-zinc-800">
    ...
    dark:text-hint-of-red-400/40 dark:hover:text-hint-of-red-200" href="https://github.com/malformed-c/dnote/" target="_blank" rel="noopener noreferrer">Our project on GitHub</a>
